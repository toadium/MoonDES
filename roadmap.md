...
| v1.8.0 | 进程增强与经典示例 | interrupt/on_complete + 哲学家/生产者-消费者 | ✅ 已完成 |
| v1.9.0 | 性能基准测试 | 事件吞吐量/进程扩展/资源竞争/同步原语 | ✅ 已完成 |
| **v2.0.0** | **API 稳定化与正式发布** | **十一层架构完备，276 测试，SemVer 承诺** | **✅ 已发布** |
| v2.1.0 | 网络仿真层 | Packet/Link/Channel/Router | ✅ 已完成 |
| v2.2.0 | FilterStore + 高级示例 | 谓词仓库 + Monte Carlo + M/M/c | ✅ 已完成 |
| v2.3.0 | 有限状态机层 | State/Transition/StateMachine | ✅ 已完成 |
| v2.4.0 | 事件总线层 | EventBus 发布订阅 | ✅ 已完成 |
| v2.5.0 | 定时器层 + 交通系统 | Timer + 综合示例 | ✅ 已完成 |
| v2.6.0 | 进程组 + 电梯调度 | ProcessGroup + 综合示例 | ✅ 已完成 |
| v2.7.0 | 条件变量+序列化+医院急诊 | ConditionVariable+SimulationSnapshot | ✅ 已完成 |
| v2.8.0 | 流水线+水处理厂 | Pipeline+综合示例 | ✅ 已完成 |
| v2.9.0 | 图网络+社交网络 | Graph+综合示例 | ✅ 已完成 |
| v3.0.0 | 马尔可夫链+传染病 | MarkovChain+SIR模型 | ✅ 已完成 |
| v3.1.0 | 空间网格+元胞自动机 | Grid2D+CA+森林火灾 | ✅ 已完成 |
